...
hub_connection1 = HubConnectionBuilder() \
                .with_url('http://10.10.10.211:5044/ImageHub', options={"verify_ssl": False}) \
...
hub_connection2 = HubConnectionBuilder() \
                   .with_url('http://10.10.10.211:5044/aiHub', options={"verify_ssl": False}) \
              .with_automatic_reconnect({
               "type": "interval",
              "keep_alive_interval": 10,
               "intervals": [1, 3, 5, 6, 7, 87, 3]
...
hub_connection1 .on("SendMessage", sendMessage)
print(sendMessage)
...
class VideoTransformTrack(MediaStreamTrack):
    ...
    async def recv(self):
        ...
        # !!!!! yolo 모델로 처리할 코드 추가
            ...
            result = myai.run(model=model, origin_img=img)
